...
# Note: These are curated approximations for the specified transcripts
EXONS = {
    "ASXL1_NM_015338.5": [
...
if INPUT_DATA:
    ...
    # Accuracy caveat
    st.caption("⚠️ Exon boundaries and domain positions are approximate visual aids based on the selected transcript. "
               "Refer to NCBI/Ensembl for precise genomic coordinates.")
